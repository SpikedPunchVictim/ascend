 ...
 */
export { PROPERTY_TYPES, UNIT_BEARING_TYPES, canonicalName, canonicalizeProperty, canonicalizeTypeSpec, type Canonicalized, type PropertySpec, type PropertyType, type Rename, type TypeSpec, } from './spec.js';
